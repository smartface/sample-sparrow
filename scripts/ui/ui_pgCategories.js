...
const PgCategories_ = extend(Page)(
	//constructor
	function(_super, props) {
		...
		var customHeaderBar = new CustomHeaderBar(customHeaderBarStyle, "pgCategories");
		...
		var loaderContainer = new LoaderContainer(loaderContainerStyle, "pgCategories");
...
module && (module.exports = PgCategories_);